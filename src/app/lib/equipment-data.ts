...
export const EQUIPMENT: Equipment[] = [
  ...
  // ── CÁMARAS ───────────────────────────────────────────────────────────────
  {
    ...
    specs: [
      { label: "Sensor", value: "APS-C / Super 35 de 26.1 MP" },
      { label: "Video", value: "4K hasta 120 fps" },
      { label: "Color", value: "10-bit 4:2:2" },
      { label: "Salida RAW", value: "16-bit" },
      { label: "Perfil", value: "S-Cinetone / S-Log3" },
      { label: "ISO", value: "Dual Base ISO" },
      { label: "Autofocus", value: "Seguimiento en tiempo real" },
    ...
    idealFor: ["Producción de comerciales", "Videoclips musicales", "Cortometrajes y documentales", "Streaming profesional", "Podcasts premium", "Eventos corporativos", "Producción para YouTube y redes sociales", "Grabaciones multicámara"],
    priceDay: "S/ 300",
    priceEvent: "S/ 500 fin de semana",
    available: true,
    isNew: true,
    badge: "Cinema",
    whatsappBase: "https://wa.link/7cmlp3",
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Color", value: "10-bit 4:2:2" },
      { label: "Autofocus", value: "Eye AF con IA" },
      { label: "Estabilización", value: "5 ejes integrada" },
      { label: "Perfil", value: "S-Cinetone / S-Log3" },
      { label: "Tarjetas", value: "SD / CFexpress doble ranura" },
      { label: "Montura", value: "Sony E-Mount" },
    ],
    includes: [
      "Sony A7 IV",
    ...
    idealFor: ["Producción audiovisual profesional", "Fotografía de eventos y bodas", "Videoclips musicales", "Producción para YouTube y redes sociales", "Streaming profesional", "Fotografía corporativa y comercial", "Documentales y entrevistas", "Contenido cinematográfico independiente"],
    priceDay: "S/ 250",
    priceEvent: "S/ 450 fin de semana",
    available: true,
    isNew: true,
    whatsappBase: "https://wa.link/7cmlp3",
    addedAt: "2025-05-01",
  },
  {
    ...
    brand: "Sony",
    category: "camaras",
    images: ["/equipo/sony-a6400.png", "/equipo/sony-a64001.png"],
    tagline: "Mirrorless APS-C compacta con autofocus ultrarrápido y 4K",
    description:
      "La Sony Alpha 6400 es una cámara mirrorless APS-C compacta y versátil, diseñada para fotografía y video profesional ligero. Destaca por su autofocus ultrarrápido, grabación en 4K y excelente calidad de imagen, convirtiéndose en una de las cámaras favoritas para creadores de contenido, streamers, fotógrafos y videógrafos independientes.",
    specs: [
      { label: "Sensor", value: "APS-C Exmor de 24.2 MP" },
      { label: "Video", value: "4K UHD" },
      { label: "Autofocus", value: "425 puntos, Eye AF" },
      { label: "Pantalla", value: "Abatible 180°" },
      { label: "Disparo", value: "Hasta 11 fps" },
      { label: "ISO", value: "Expandible hasta 102400" },
    ...
    idealFor: ["Producción de contenido para YouTube", "Streaming y podcasts", "Fotografía social y eventos", "Videoclips musicales", "Producción audiovisual ligera", "Cobertura de eventos corporativos", "Fotografía de viajes", "Creación de contenido para redes sociales"],
    priceDay: "S/ 200",
    priceEvent: "S/ 350 fin de semana",
    available: true,
    isNew: true,
    whatsappBase: "https://wa.link/7cmlp3",
    addedAt: "2025-05-01",
